...
setup(
    ...
    ext_modules = [
        Extension(
            ...
            extra_compile_args=["-DPYTHON_BUILD=1", "-DTOKENIZATION_METHOD=0", "-DENABLE_UDPIPE_PARSING=0", "-g3", "-DDEBUG", "-Wall", "-Wextra", "-std=c99", "-pthread", "-pedantic", "-fstack-protector-all"]
        )
    ]
)
