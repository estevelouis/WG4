...
int32_t filter_compile(struct filter *const f) {
  ...
  f->regex = pcre2_compile(f->pattern_match, PCRE2_ZERO_TERMINATED, f->options_compile, &errorcode, &erroroffset, NULL);
  if (f->regex == NULL) {
...
struct filter filters[] = {
    ...
    {
        .regex = NULL,
        .pattern_match = (unsigned char *)"</?[a-z0-9]{1,32}+(\\s+[a-z0-9]{1,32}+=\"[^\"]{0,128}+\"){0,16}+\\s?/?>",
        .options_compile = PCRE2_UCP | PCRE2_UTF | PCRE2_DOTALL | PCRE2_CASELESS,
        .replacement = (unsigned char *)"[XML]",
        .options_replace = PCRE2_SUBSTITUTE_LITERAL | PCRE2_SUBSTITUTE_GLOBAL | PCRE2_SUBSTITUTE_OVERFLOW_LENGTH,
    },
#endif
#if ENABLE_FILTER_PATH == 1
    {
        .regex = NULL,
        .pattern_match = (unsigned char *)"(?<!/)(/[a-z0-9\\-\\._]{1,64}+){1,32}+/?",
        .options_compile = PCRE2_UCP | PCRE2_UTF | PCRE2_DOTALL | PCRE2_CASELESS,
        .replacement = (unsigned char *)"[PATH]",
        .options_replace = PCRE2_SUBSTITUTE_LITERAL | PCRE2_SUBSTITUTE_GLOBAL | PCRE2_SUBSTITUTE_OVERFLOW_LENGTH,
    },
#endif
    ...
    {
        .regex = NULL,
        .pattern_match = (unsigned char *)"[a-z0-9\\-_\\.]{1,32}+@([a-z0-9\\-_]{1,32}+\\.){1,4}+[a-z0-9]{1,6}+",
        .options_compile = PCRE2_UCP | PCRE2_UTF | PCRE2_DOTALL | PCRE2_CASELESS,
        .replacement = (unsigned char *)"[EMAIL]",
        .options_replace = PCRE2_SUBSTITUTE_LITERAL | PCRE2_SUBSTITUTE_GLOBAL | PCRE2_SUBSTITUTE_OVERFLOW_LENGTH,
    },
#endif
#if ENABLE_FILTER_URL == 1
    {
        ...
        (\\#\\S{,64}+)?\n\
        ",
        .options_compile = PCRE2_UCP | PCRE2_UTF | PCRE2_DOTALL | PCRE2_CASELESS | PCRE2_EXTENDED,
        .replacement = (unsigned char *)"[URL]",
        .options_replace = PCRE2_SUBSTITUTE_LITERAL | PCRE2_SUBSTITUTE_GLOBAL | PCRE2_SUBSTITUTE_OVERFLOW_LENGTH,
    },
/*
...
", .options_compile = PCRE2_UCP | PCRE2_UTF | PCRE2_DOTALL | PCRE2_EXTENDED, .replacement = (unsigned char*) "[URL]",
.options_replace = PCRE2_SUBSTITUTE_LITERAL | PCRE2_SUBSTITUTE_GLOBAL | PCRE2_SUBSTITUTE_OVERFLOW_LENGTH, },
*/
#endif
#if ENABLE_FILTER_ALPHANUM == 1
    // { .regex = NULL, .pattern_match = (unsigned char*) "[a-z0-9\\+\\-\\.]{,32}[0-9][a-z0-9\\+\\-\\.]{,32}", .options_compile
    // = PCRE2_UCP | PCRE2_UTF | PCRE2_DOTALL | PCRE2_CASELESS, .replacement = (unsigned char*) "[ALPHANUM]", .options_replace =
    // PCRE2_SUBSTITUTE_LITERAL | PCRE2_SUBSTITUTE_GLOBAL | PCRE2_SUBSTITUTE_OVERFLOW_LENGTH, }, { .regex = NULL, .pattern_match
    // = (unsigned char*) "\\w{,32}[0-9]\\w{,32}", .options_compile = PCRE2_UCP | PCRE2_UTF | PCRE2_DOTALL | PCRE2_CASELESS,
    // .replacement = (unsigned char*) "[ALPHANUM]", .options_replace = PCRE2_SUBSTITUTE_LITERAL | PCRE2_SUBSTITUTE_GLOBAL |
    // PCRE2_SUBSTITUTE_OVERFLOW_LENGTH, },
    {
        .regex = NULL,
        .pattern_match = (unsigned char *)"\\w*?[0-9]\\w*+",
        .options_compile = PCRE2_UCP | PCRE2_UTF | PCRE2_DOTALL | PCRE2_CASELESS,
        .replacement = (unsigned char *)"[ALPHANUM]",
        .options_replace = PCRE2_SUBSTITUTE_LITERAL | PCRE2_SUBSTITUTE_GLOBAL | PCRE2_SUBSTITUTE_OVERFLOW_LENGTH,
    },
#endif
    ...
    {
        .regex = NULL,
        .pattern_match = (unsigned char *)"\\S{30,}+",
        .options_compile = PCRE2_UCP | PCRE2_UTF | PCRE2_DOTALL,
        .replacement = (unsigned char *)"[LONG]",
        .options_replace = PCRE2_SUBSTITUTE_LITERAL | PCRE2_SUBSTITUTE_GLOBAL | PCRE2_SUBSTITUTE_OVERFLOW_LENGTH,
    },
#endif
    ...
    {
        .regex = NULL,
        .pattern_match = (unsigned char *)"\\w{0,8}[^0-9a-zàâäéèêëìîïòôöùûüç\\s&~\"#'\\{\\(\\[\\|\\|\\`_\\\\\\^@\\)\\]°\\+=\\}"
                                          "\\$£%µ\\*§!:/;\\.,\\?<>]\\w++",
        .options_compile = PCRE2_UCP | PCRE2_UTF | PCRE2_DOTALL | PCRE2_CASELESS,
        .replacement = (unsigned char *)"[NON_FRENCH]",
        .options_replace = PCRE2_SUBSTITUTE_LITERAL | PCRE2_SUBSTITUTE_GLOBAL | PCRE2_SUBSTITUTE_OVERFLOW_LENGTH,
    },
#endif
};
...
int32_t filter_substitute_all(char **const s, size_t *const s_len) {
  ...
  substitution:
    ...
    num_sub =
        pcre2_substitute(filters[i].regex, subject, PCRE2_ZERO_TERMINATED, startoffset, filters[i].options_replace, match_data,
                         mcontext, filters[i].replacement, PCRE2_ZERO_TERMINATED, outputbuffer, &outputlength);
